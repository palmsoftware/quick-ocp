...
echo "vsock child_ns_mode: $(cat /proc/sys/net/vsock/child_ns_mode 2>/dev/null || echo 'N/A')"
echo "vsock ns_mode: $(cat /proc/sys/net/vsock/ns_mode 2>/dev/null || echo 'N/A')"
echo "CRC cache dir:"
